 ...
 *  @since 2.0
 */
public class FoodserviceStaffMealCounts extends SIFDataObject
{
	...
	public FoodserviceStaffMealCounts() {
		super( ADK.getSIFVersion(), FoodDTD.FOODSERVICESTAFFMEALCOUNTS );
	}
	 ...
	 *  @param counts 
	 */
	public FoodserviceStaffMealCounts( String refId, String schoolInfoRefId, Calendar date, Program program, Counts counts ) {
		super( ADK.getSIFVersion(), FoodDTD.FOODSERVICESTAFFMEALCOUNTS );
		this.setRefId(refId);
	...
	public String getKey() {
		return getFieldValue( FoodDTD.FOODSERVICESTAFFMEALCOUNTS_REFID );
	}
	...
	public ElementDef[] getKeyFields() {
		return new ElementDef[] { FoodDTD.FOODSERVICESTAFFMEALCOUNTS_REFID };
	}
	...
	* <i>"Date on which the sales occurred."</i><p>
	...
	public Calendar getDate() { 
		return (Calendar) getSIFSimpleFieldValue( FoodDTD.FOODSERVICESTAFFMEALCOUNTS_DATE );
	}
