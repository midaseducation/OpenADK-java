 ...
 *  @since 2.0
 */
public class FoodserviceStudentMealCounts extends SIFDataObject
{
	private static final long serialVersionUID = Element.CURRENT_SERIALIZE_VERSION;
	/**
	 *  Constructor
	 */
	public FoodserviceStudentMealCounts() {
		super( ADK.getSIFVersion(), FoodDTD.FOODSERVICESTUDENTMEALCOUNTS );
	}
	 ...
	 *  @param counts 
	 */
	public FoodserviceStudentMealCounts( String refId, String schoolInfoRefId, Calendar date, Program program, Counts counts ) {
		super( ADK.getSIFVersion(), FoodDTD.FOODSERVICESTUDENTMEALCOUNTS );
		this.setRefId(refId);
	...
	public String getKey() {
		return getFieldValue( FoodDTD.FOODSERVICESTUDENTMEALCOUNTS_REFID );
	}
	...
	public ElementDef[] getKeyFields() {
		return new ElementDef[] { FoodDTD.FOODSERVICESTUDENTMEALCOUNTS_REFID };
	}
	...
	* <i>"Date on which the sales occurred."</i><p>
	...
	public Calendar getDate() { 
		return (Calendar) getSIFSimpleFieldValue( FoodDTD.FOODSERVICESTUDENTMEALCOUNTS_DATE );
	}
