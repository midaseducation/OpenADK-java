 ...
 *  @since 1.1
 */
public class ExitStatus extends SIFKeyedElement
{
	 ...
	 */
	public ExitStatus( ExitStatusCode code ) {
		super( CommonDTD.EXITSTATUS );
		this.setCode( code );
	}
	...
	public ElementDef[] getKeyFields() {
		return new ElementDef[] { CommonDTD.EXITSTATUS_CODE };
	}

	/**
	 *  Gets the value of the <code>Code</code> attribute.
	* <p> The SIF specification defines the meaning of this attribute as: 
	* <i>"Code indicating the exit status for this affiliation."</i><p>
	 *
	...
	* <i>"Code indicating the exit status for this affiliation."</i><p>
	 *
	 *  @param value A constant defined by the <code>ExitStatusCode</code> class
	 *  @since 1.1
	 */
	public void setCode( ExitStatusCode value ) { 
