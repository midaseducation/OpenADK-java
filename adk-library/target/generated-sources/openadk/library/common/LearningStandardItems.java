 ...
 *  @since 2.1
 */
public class LearningStandardItems extends SIFKeyedList<LearningStandardItemRefId>
{
	private static final long serialVersionUID = Element.CURRENT_SERIALIZE_VERSION;
	/**
	 *  Constructor
	 */
	public LearningStandardItems() {
		super( CommonDTD.LEARNINGSTANDARDITEMS );
	}

	/**
	 *  Constructor that accepts values for all mandatory fields
	 *  @param learningStandardItemRefId 
	 */
	public LearningStandardItems( LearningStandardItemRefId learningStandardItemRefId ) {
		super( CommonDTD.LEARNINGSTANDARDITEMS );
	...
	public void removeLearningStandardItemRefId( String value ) { 
		removeChild( CommonDTD.LEARNINGSTANDARDITEMS_LEARNINGSTANDARDITEMREFID, new String[] { value.toString() } );
	}
	...
	public LearningStandardItemRefId getLearningStandardItemRefId( String value ) { 
		return (LearningStandardItemRefId)getChild( CommonDTD.LEARNINGSTANDARDITEMS_LEARNINGSTANDARDITEMREFID, new String[] { value.toString() } );
	}
	...
	public LearningStandardItemRefId[] getLearningStandardItemRefIds() {
		List<SIFElement> v = getChildList( CommonDTD.LEARNINGSTANDARDITEMS_LEARNINGSTANDARDITEMREFID);
	...
	public void setLearningStandardItemRefIds( LearningStandardItemRefId[] learningstandarditemrefids ) {
		setChildren( CommonDTD.LEARNINGSTANDARDITEMS_LEARNINGSTANDARDITEMREFID, learningstandarditemrefids );
	}
