...
public class SIF_Unsubscribe extends SIFMessagePayload
{
	...
	* <i>"Header information associated with this message."</i><p>
	...
	public void addSIF_Object( SIF_Object value ) { 
		addChild( InfraDTD.SIF_UNSUBSCRIBE_SIF_OBJECT, value);
	}
	...
	public SIF_Object[] getSIF_Objects() {
		List<SIFElement> v = getChildList( InfraDTD.SIF_UNSUBSCRIBE_SIF_OBJECT);
	...
	public void setSIF_Objects( SIF_Object[] sif_objects ) {
		setChildren( InfraDTD.SIF_UNSUBSCRIBE_SIF_OBJECT, sif_objects );
	}
