 ...
 *  @since 2.0
 */
public class SIF_RespondObjects extends SIFKeyedList<SIF_Object>
{
	private static final long serialVersionUID = Element.CURRENT_SERIALIZE_VERSION;
	/**
	 *  Constructor
	 */
	public SIF_RespondObjects() {
		super( InfraDTD.SIF_RESPONDOBJECTS );
	}
	 ...
	 *  @param sifObject 
	 */
	public SIF_RespondObjects( SIF_Object sifObject ) {
		super( InfraDTD.SIF_RESPONDOBJECTS );
	...
	public void removeSIF_Object( String objectName ) { 
		removeChild( InfraDTD.SIF_RESPONDOBJECTS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object getSIF_Object( String objectName ) { 
		return (SIF_Object)getChild( InfraDTD.SIF_RESPONDOBJECTS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object[] getSIF_Objects() {
		List<SIFElement> v = getChildList( InfraDTD.SIF_RESPONDOBJECTS_SIF_OBJECT);
	...
	public void setSIF_Objects( SIF_Object[] sif_objects ) {
		setChildren( InfraDTD.SIF_RESPONDOBJECTS_SIF_OBJECT, sif_objects );
	}
