 ...
 *  @since 1.1
 */
public class SIF_Subscribe extends SIFMessagePayload
{
	 ...
	 */
	public SIF_Subscribe( SIFVersion sifVersion ) {
		super( sifVersion, InfraDTD.SIF_SUBSCRIBE );
	}
	...
	* <i>"Header information associated with this message."</i><p>
	...
	public void addSIF_Object( SIF_Object value ) { 
		addChild( InfraDTD.SIF_SUBSCRIBE_SIF_OBJECT, value);
	}
	...
	public SIF_Object[] getSIF_Objects() {
		List<SIFElement> v = getChildList( InfraDTD.SIF_SUBSCRIBE_SIF_OBJECT);
	...
	public void setSIF_Objects( SIF_Object[] sif_objects ) {
		setChildren( InfraDTD.SIF_SUBSCRIBE_SIF_OBJECT, sif_objects );
	}
