 ...
 *  @since 2.4
 */
public class SIF_SubscribeService extends SIFList<SIF_ServiceRequestSubscribe>
{
	private static final long serialVersionUID = Element.CURRENT_SERIALIZE_VERSION;
	/**
	 *  Constructor
	 */
	public SIF_SubscribeService() {
		super( InfraDTD.SIF_SUBSCRIBESERVICE );
	}
	 ...
	 *  @param sifService 
	 */
	public SIF_SubscribeService( SIF_ServiceRequestSubscribe sifService ) {
		super( InfraDTD.SIF_SUBSCRIBESERVICE );
		this.safeAddChild( InfraDTD.SIF_SUBSCRIBESERVICE_SIF_SERVICE, sifService );
	}
	...
	public SIF_ServiceRequestSubscribe[] getSIF_Services() {
		List<SIFElement> v = getChildList( InfraDTD.SIF_SUBSCRIBESERVICE_SIF_SERVICE);
	...
	public void setSIF_Services( SIF_ServiceRequestSubscribe[] sif_services ) {
		setChildren( InfraDTD.SIF_SUBSCRIBESERVICE_SIF_SERVICE, sif_services );
	}
