 ...
 *  @since 2.0
 */
public class SIF_PublishDeleteObjects extends SIFKeyedList<SIF_Object>
{
	private static final long serialVersionUID = Element.CURRENT_SERIALIZE_VERSION;
	/**
	 *  Constructor
	 */
	public SIF_PublishDeleteObjects() {
		super( InfraDTD.SIF_PUBLISHDELETEOBJECTS );
	}
	 ...
	 *  @param sifObject 
	 */
	public SIF_PublishDeleteObjects( SIF_Object sifObject ) {
		super( InfraDTD.SIF_PUBLISHDELETEOBJECTS );
	...
	public String getKey() {
		return getFieldValue( InfraDTD.SIF_PUBLISHDELETEOBJECTS_SIF_OBJECT );
	}
	...
	public ElementDef[] getKeyFields() {
		return new ElementDef[] { InfraDTD.SIF_PUBLISHDELETEOBJECTS_SIF_OBJECT };
	}
	...
	public void removeSIF_Object( String objectName ) { 
		removeChild( InfraDTD.SIF_PUBLISHDELETEOBJECTS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object getSIF_Object( String objectName ) { 
		return (SIF_Object)getChild( InfraDTD.SIF_PUBLISHDELETEOBJECTS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object[] getSIF_Objects() {
		List<SIFElement> v = getChildList( InfraDTD.SIF_PUBLISHDELETEOBJECTS_SIF_OBJECT);
	...
	public void setSIF_Objects( SIF_Object[] sif_objects ) {
		setChildren( InfraDTD.SIF_PUBLISHDELETEOBJECTS_SIF_OBJECT, sif_objects );
	}
