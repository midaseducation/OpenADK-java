 ...
 *  @since 2.0
 */
public class SIF_SubscribeObjects extends SIFKeyedList<SIF_Object>
{
	private static final long serialVersionUID = Element.CURRENT_SERIALIZE_VERSION;
	/**
	 *  Constructor
	 */
	public SIF_SubscribeObjects() {
		super( InfraDTD.SIF_SUBSCRIBEOBJECTS );
	}
	 ...
	 *  @param sifObject 
	 */
	public SIF_SubscribeObjects( SIF_Object sifObject ) {
		super( InfraDTD.SIF_SUBSCRIBEOBJECTS );
	...
	public String getKey() {
		return getFieldValue( InfraDTD.SIF_SUBSCRIBEOBJECTS_SIF_OBJECT );
	}
	...
	public ElementDef[] getKeyFields() {
		return new ElementDef[] { InfraDTD.SIF_SUBSCRIBEOBJECTS_SIF_OBJECT };
	}
	...
	public void removeSIF_Object( String objectName ) { 
		removeChild( InfraDTD.SIF_SUBSCRIBEOBJECTS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object getSIF_Object( String objectName ) { 
		return (SIF_Object)getChild( InfraDTD.SIF_SUBSCRIBEOBJECTS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object[] getSIF_Objects() {
		List<SIFElement> v = getChildList( InfraDTD.SIF_SUBSCRIBEOBJECTS_SIF_OBJECT);
	...
	public void setSIF_Objects( SIF_Object[] sif_objects ) {
		setChildren( InfraDTD.SIF_SUBSCRIBEOBJECTS_SIF_OBJECT, sif_objects );
	}
