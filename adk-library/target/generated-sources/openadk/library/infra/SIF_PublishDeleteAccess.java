...
public class SIF_PublishDeleteAccess extends SIFKeyedList<SIF_Object>
{
	 ...
	 *  @param sifObject 
	 */
	public SIF_PublishDeleteAccess( SIF_Object sifObject ) {
		super( InfraDTD.SIF_PUBLISHDELETEACCESS );
	...
	public void removeSIF_Object( String objectName ) { 
		removeChild( InfraDTD.SIF_PUBLISHDELETEACCESS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object getSIF_Object( String objectName ) { 
		return (SIF_Object)getChild( InfraDTD.SIF_PUBLISHDELETEACCESS_SIF_OBJECT, new String[] { objectName.toString() } );
	}
	...
	public SIF_Object[] getSIF_Objects() {
		List<SIFElement> v = getChildList( InfraDTD.SIF_PUBLISHDELETEACCESS_SIF_OBJECT);
	...
	public void setSIF_Objects( SIF_Object[] sif_objects ) {
		setChildren( InfraDTD.SIF_PUBLISHDELETEACCESS_SIF_OBJECT, sif_objects );
	}
